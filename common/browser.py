...
class Browser(object):
    def __init__(self, driver_path=dri_path, driver_name=config.driver_name):
        self.__driver_path = driver_path
        self.__driver_name = driver_name

    def get_driver(self):
        if self.__driver_name.lower() == "chrome":
            return self.__get_chrome_dirver()
    ...
    def __get_remote_driver(self):  # selenium支持分布式 grid
        pass
